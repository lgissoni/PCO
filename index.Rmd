...
description: "Bacharelado em direito - Universidade Zumbi dos Palmares\n"
site: distill::distill_website
bibliography: PCO.bib
csl: abnt.csl
resource_files:
  - resources/lamounier.pdf
---
...
[@barroso_pratica_2024](resources/lamounier.pdf)  
@dimoulis_curso_2016
...
- [Legislação Federal](https://www.planalto.gov.br/ccivil_03/constituicao/constituicao.htm)  
...
O compromisso com a **autenticidade e integridade acadêmica** é essencial para o aprendizado e desenvolvimento profissional. O uso indevido de **inteligência artificial (IA)** e a prática de **plágio** comprometem esse princípio e terão **consequências rigorosas**.
...
⚠️ <strong>Atenção:</strong> as atividades plagiadas serão anuladas e a nota atribuída será zero.
</div>
...
<div class="warning" style='background-color: #fff3cd; color: #856404; border-left: solid #ffeeba 4px; border-radius: 4px; padding:0.7em;'>
⚠️ <strong>Atenção:</strong> A identificação do uso não autorizado de IA resultará na anulação da atividade e atribuição de nota zero.
</div>
